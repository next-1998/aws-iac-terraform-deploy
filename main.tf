...
module "elb" {
  ...
  pub_subnet_ids = module.default_network.public_subnet_ids
  pri_subnet_ids = module.default_network.public_subnet_ids
  ...
  cluster_name = var.cluster_name
  root_domain = local.root_domain
  route53_zone_zone_id = module.default_network.route53_zone_zone_id
  common_tags = var.common_tags
  resource_tags = {}
}
...
# module "rds_network" {
#   source = "./deployment/rds/rds_network"
...
#   vpc_secondary_cidr = var.vpc_secondary_cidr
#   common_tags = var.common_tags
#   nat_gateway_id = module.default_network.pri_nat_gw.id
#   tgw_route_target_ips = var.tgw_route_target_ips
#   attachment_tgw = var.attachment_tgw
# }

# # module "rds" {
# #   source = "./deployment/rds/rds"
# #   count = local.create_db ? 1 : 0
...
# #   vpc_security_group_ids = [module.security_group_rds[0].security_group_id]
